          ...
          <a class="nav-link" data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/samples/registerd.php"> Depot </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/samples/etatd.php"> Etat </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                        <span>
                          <a href="pages/samples/etatd.php" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Consulter!</a>
                        </span>
                      </div>
                    </div>
                  </div>
