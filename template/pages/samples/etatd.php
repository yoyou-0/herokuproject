      ...
      <nav class="navbar p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown"  href="registerd.php">+ Deposer un nouveau dossier</a>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Suivez l'état de votre projet! </h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../../index.php">Acceuil</a></li>
                <li class="breadcrumb-item active" aria-current="registerd.php">Dossier</li>
                <li class="breadcrumb-item active" aria-current="registerd.php">Etat</li>
              </ol>
            </nav>
          </div>
          <div class="row ">
              <div class="col-12 grid-margin">
                ...
                foreach ($es->findDossierByUsername($_SESSION['auth']->username) as $e) {
                    ...
                    <tr>
                        ...
                        <?php } ?>
                        <td>      
                            <a href="controller/deleteDossier.php?id=
